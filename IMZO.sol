...
contract IMZO is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'IMZO';
    string  private constant _SYMBOL = 'IMZO';
    ...
    uint256 private _tTotal = 1100000 * _DECIMALFACTOR;
